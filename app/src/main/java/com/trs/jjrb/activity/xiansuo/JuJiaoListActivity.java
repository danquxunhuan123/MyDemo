...
public class JuJiaoListActivity extends BaseActivity
{
    ...
    protected void getData() {
        ...
        transaction.replace(R.id.fl_content
                , CommenListFragment.newInstance(url, factory.getAdapter(12, this)))
                .commit();
    ...
    protected int flateLayout() {
        return R.layout.layout_activity_jujiao_list;
    }
