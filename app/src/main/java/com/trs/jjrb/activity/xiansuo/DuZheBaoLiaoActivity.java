...
public class DuZheBaoLiaoActivity extends BaseActivity
{
    ...
    protected void getData() {
        ...
        transaction.replace(R.id.fl_content
                , CommenListFragment.newInstance(url, factory.getAdapter(15, this)))
                .commit();
    ...
    protected int flateLayout() {
        return R.layout.layout_activity_duzhe_baoliao;
    }
