...
public class TuFaPageFragment extends BaseFragment implements IListView,
    ...
    public static TuFaPageFragment newInstance(String param1, String param2) {
        TuFaPageFragment fragment = new TuFaPageFragment();
    ...
    protected int flateLayout() {
        return R.layout.layout_list_tufa;
    }
        ...
        if (obj instanceof Channel) {
            ...
            if (adapter == null) {
                if ("走出国境".equals(cname))
                    ...
                    adapter = new TuFaListAdapter( mList, mContext);
            ...
            if (adapter == null) {
                ...
                if (pageCount == 0) {
//                    if (adapter instanceof TuFaListAdapter) {
//                        ((TuFaListAdapter) adapter).setBannerData(top_datas);
//                    }
                    adapter.updateData(mList);
                } else
                    adapter.addData(mList);
